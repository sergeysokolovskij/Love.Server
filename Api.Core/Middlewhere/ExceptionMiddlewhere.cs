...
namespace ShopPlatforms.Core.Middlewhere
{
	public class ExceptionMiddlewhere
	{
		...
		private readonly ILogger<ExceptionMiddlewhere> logger;

		public ExceptionMiddlewhere(RequestDelegate next, 
			ILoggerFactory loggerFactory)
		{
			this.next = next;
			logger = loggerFactory?.CreateLogger<ExceptionMiddlewhere>() ??
